      ...
      <main className="px-6 md:px-10 lg:max-w-4xl mx-auto">
        ...
        <div className="relative mb-8 max-w-xl mx-auto">
          <input
            ...
            className="w-full py-4 px-6 border-2 border-gray-300 rounded-full text-gray-700 placeholder-gray-500 focus:outline-none focus:border-[#FF5A5A] font-inter text-base pr-16"
          />
        ...
        <div className="flex justify-center flex-wrap gap-x-4 md:gap-x-8 gap-y-4 mb-8">
          {taskTypes.slice(0, 5).map((task, index) => {
            ...
            return (
              ...
              >
                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-2 transition-colors bg-gray-100 border border-gray-200 hover:border-[#FF5A5A]`}>
