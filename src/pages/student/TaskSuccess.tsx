  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-6 bg-gray-50">
      <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-8 max-w-sm w-full text-center">
        <CheckCircle2 size={64} className="text-yana-yellow mx-auto mb-6" strokeWidth={1.5} />
        ...
        <Link
          to="/create-task"
          className="w-full inline-block bg-yana-yellow text-white py-3 px-6 rounded-lg font-semibold text-lg"
        >
