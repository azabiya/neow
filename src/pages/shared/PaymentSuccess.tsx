    ...
    <div className="flex flex-col min-h-screen max-w-md mx-auto bg-white p-6 font-inter">
      ...
      <main className="flex-grow flex flex-col items-center justify-center">
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8 max-w-sm w-full text-center">
          <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-6 border-2 border-primary">
          ...
          <button
            ...
            className="w-full inline-block bg-primary text-white py-3 px-6 rounded-lg font-normal text-sm"
          >
