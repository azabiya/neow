                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 items-end gap-16">
                        ...
                        <div className="flex justify-center md:justify-end">
                            <button onClick={() => navigate('/register')} className="px-8 py-3 text-base font-semibold bg-[#FF5A5A] text-white rounded-lg hover:bg-[#E14C4C] transition-all">Crear tarea</button>
                        </div>
                    </div>
                </div>
            </section>
