...
// --- COMPONENTE ACORDEÓN (FAQ) (Sin cambios) ---
        ...
        <div className="min-h-screen bg-white font-inter text-black overflow-x-hidden">
                      ...
                      <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-8 md:p-12">
                           <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 text-center">
                                <div className="flex flex-col items-center">
                                     <div className="w-16 h-16 bg-red-100 rounded-xl flex items-center justify-center mb-4"><MoneyIcon /></div>
                                 ...
                                 <div className="flex flex-col items-center">
                                     <div className="w-16 h-16 bg-red-100 rounded-xl flex items-center justify-center mb-4"><FlexibilityIcon /></div>
                                 ...
                                 <div className="flex flex-col items-center">
                                     <div className="w-16 h-16 bg-red-100 rounded-xl flex items-center justify-center mb-4"><GrowthIcon /></div>
            ...
            <section className="py-20 lg:py-24 bg-[#F7F7F7]">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-black">Qué necesitas para <span className="text-[#FF5A5A]">unirte</span></h2>
            ...
            <section className="py-20 lg:py-24">
                 <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                       <div className="bg-white border border-[#E0DDDD] rounded-2xl shadow-xl p-8 md:p-12 text-center">
                            <h2 className="text-3xl font-bold text-[#FF5A5A]">¿Listo para empezar a ganar?</h2>
