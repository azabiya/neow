    ...
    return (
        <div>
            ...
            <div className="relative">
                <input id={id} name={id} type={isPassword && showPassword ? 'text' : type} placeholder={placeholder} value={value} onChange={onChange} className="w-full py-2 bg-transparent border-b border-gray-300 focus:outline-none focus:border-primary" required />
...
const Step2 = ({ formData, handleChange, universities, careers }: { formData: FormData, handleChange: (e: React.ChangeEvent<HTMLSelectElement>) => void, universities: DBEntity[], careers: DBEntity[] }) => (
    <div className="w-full flex flex-col gap-8 text-left">
        <div>
            ...
            <div className="relative">
                <select name="university" value={formData.university} onChange={handleChange} className="w-full py-2 text-gray-700 bg-transparent border-b border-gray-300 focus:outline-none focus:border-primary appearance-none" required>
        ...
        <div>
            ...
            <div className="relative">
                <select name="career" value={formData.career} onChange={handleChange} className="w-full py-2 text-gray-700 bg-transparent border-b border-gray-300 focus:outline-none focus:border-primary appearance-none" required>
                     <option value="">Selecciona</option>
        ...
        <div>
            ...
            <div className="relative">
                <select name="semester" value={formData.semester} onChange={handleChange} className="w-full py-2 text-gray-700 bg-transparent border-b border-gray-300 focus:outline-none focus:border-primary appearance-none" required>
                    <option value="">Selecciona</option>
        ...
        <div className="flex flex-col min-h-screen p-6 bg-white relative md:items-center md:justify-center">
            <div className="w-full md:max-w-md flex flex-col flex-grow md:flex-grow-0">
                ...
                <footer className="w-full mt-auto pt-10 flex gap-4">
                    ...
                    <button onClick={nextStep} disabled={loading} className={`py-3 bg-primary text-white rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-yellow-600 transition-colors ${step === 1 ? 'w-full' : 'w-1/2'}`}>
