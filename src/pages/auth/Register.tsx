    ...
    return (
        <div className="flex flex-col min-h-screen p-6 bg-white relative md:items-center md:justify-center">
            <div className="w-full md:max-w-md flex flex-col flex-grow md:flex-grow-0">
                <header className="text-center pt-8 md:pt-0 pb-8"> <h1 className="text-5xl font-days font-normal text-[#00B8DB]">NEOW&lt;</h1> </header>
                <main className="flex-grow flex flex-col items-center w-full">
                    <div className="w-full text-center mb-8"> <h2 className="text-3xl font-normal text-black">¡Únete a Neow!</h2> </div>
                ...
                <footer className="w-full mt-auto pt-10 flex gap-4">
                    ...
                    <button onClick={nextStep} disabled={loading} className={`py-3 bg-[#00B8DB] text-white rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-cyan-600 transition-colors ${step === 1 ? 'w-full' : 'w-1/2'}`}>
