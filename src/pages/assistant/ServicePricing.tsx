            ...
            {data.map((item, index) => (
                <div key={item.id || `new-${index}`} className="grid grid-cols-10 gap-4 items-center text-sm">
                    <input 
                        ...
                        className="col-span-3 text-gray-800 text-center bg-white rounded-md p-2 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary"
                    />
                    <input 
                        type="number" 
                        placeholder={criterion === 'pages' ? 'Págs' : '%'}
                    ...
                    <input 
                        ...
                        className="col-span-3 font-medium text-gray-900 text-center bg-white rounded-md p-2 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-primary"
                    />
